...
class PjRtMemorySpaceCApiDelegator {
 ...
 private:
  ...
  static void* GetUserDataImpl(PJRT_Memory* memory, void* key);
  static void SetUserDataImpl(PJRT_Memory* memory, void* key, void* data,
                              CApiDtor dtor);
  static PJRT_Memory_FunctionTable g_delegator_vtable;
  ...
  absl::flat_hash_map<void*, UserData> user_data_;
};
